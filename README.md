...
Images live at `/sites/Production/Shared Documents/Quote Sheets/Quote Images`,
which must contain two subfolders: **thumb** and **full**. Grant the team
Contribute on **Quote Images**. Configured via `SITE_PATH`, `IMG_DRIVE`, and
`IMG_PATH` at the top of `index.html`.
